...
<head>
    ...
    <title>Photo Inventory Management</title>
</head>
<body style="font-family: Arial; text-align: center; margin-top: 50px;">

    <h2>PHOTO INVENTORY DASHBOARD</h2>

    <p>Hello, <?=htmlspecialchars($adminName) ?>. The Photo Inventory Module is under construction.</p>
