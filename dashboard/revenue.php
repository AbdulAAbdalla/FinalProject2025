...
<head>
    ...
    <title>Revenue Acounting</title>
</head>
<body style="font-family: Arial; text-align: center; margin-top: 50px;">

    <h2>REVENUE ACCOUNTING DASHBOARD</h2>

    <p>Hello, <?=htmlspecialchars($adminName) ?>. The Revenuue accounting Module is under construction.</p>
